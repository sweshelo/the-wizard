...
|----------|----------|--------|----------|------------|
| 3.1 | コンテキスト管理 | P0 | Phase 2 | NOT_STARTED |
| 3.2 | 世代管理による陳腐化検出 | P0 | 3.1 | NOT_STARTED |
| 3.3 | デッキ認識・戦略適応 | P0 | 3.2 | NOT_STARTED |
| 3.4 | コンボ検出・記録 | P1 | 3.3 | NOT_STARTED |
| 3.5 | 定期分析 (2ラウンドごと、Opus) | P0 | 3.2 | NOT_STARTED |
| 3.6 | 相手捨札傾向分析 | P1 | 3.5 | NOT_STARTED |
| 3.7 | バックグラウンド推論 | P1 | 3.5 | NOT_STARTED |
| 3.8 | 知識ストレージ (LocalStorage) | P2 | 3.4 | NOT_STARTED |
